...
def make_cases() -> List[SmokeCase]:
    return [
        ...
        SmokeCase(
            case_id="hybrid_006",
            group="HYBRID",
            question="Which department has highest cost and why?",
            expected_route="HYBRID",
            expected_sql_intent="generic_highest_cost_departments_causes",
            expected_sources_min=1,
            max_latency_seconds=45.0,
        ),
        SmokeCase(
            case_id="sql_analytics_001",
            group="SQL_ANALYTICS",
            question="Compare Radiology vs ICU costs this month",
            expected_route="SQL",
            expected_sql_intent="generic_department_cost_comparison",
            max_latency_seconds=10.0,
        ),
        SmokeCase(
            case_id="sql_analytics_002",
            group="SQL_ANALYTICS",
            question="Show me meter readings for ventilator #102",
            expected_route="SQL",
            expected_sql_intent="generic_meter_readings_by_equipment",
            max_latency_seconds=10.0,
        ),
        SmokeCase(
            case_id="sql_analytics_003",
            group="SQL_ANALYTICS",
            question="List upcoming maintenance plans",
            expected_route="SQL",
            expected_sql_intent="generic_upcoming_maintenance_plans",
            max_latency_seconds=10.0,
        ),
        SmokeCase(
            case_id="sql_analytics_004",
            group="SQL_ANALYTICS",
            question="What is the inventory valuation?",
            expected_route="SQL",
            expected_sql_intent="generic_inventory_valuation",
            max_latency_seconds=10.0,
        ),
