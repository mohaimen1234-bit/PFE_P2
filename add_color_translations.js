...
// Insert into English
content = content.replace(/(export const en = \{)/, "$1" + additionsEN);
// Insert into French
content = content.replace(/(export const fr = \{)/, "$1" + additionsFR);
// Insert into Arabic
content = content.replace(/(export const ar = \{)/, "$1" + additionsAR);
